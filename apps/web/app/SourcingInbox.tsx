...
import { ArrowRight, Atom, ChevronLeft, ChevronRight, ExternalLink, Flame, GitFork, Radar, Rocket, Sparkles, X } from "lucide-react";
...
function SourceMark({ type }: { type: string }) {
  const Icon = type === "github" ? GitFork : type === "hacker_news" ? Flame : type === "product_hunt" ? Rocket : Atom;
  return <span className={styles.sourceMark} data-source={type} aria-hidden="true"><Icon size={13} strokeWidth={1.8} /></span>;
}
